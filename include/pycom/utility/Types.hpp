...
static const char *const LISTPUSHINT = "__list_push_int";
static const char *const LISTPUSHSTR = "__list_push_str";
static const char *const LISTPUSHBOOL = "__list_push_bool";
